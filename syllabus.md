...
Instructor: Dr. David Babcock <dbabcock@ycp.edu>
...
Class times:
 ...
 -------- | --------  |  ----------- | -------
101       | Tues/Thur | 12:30-1:45PM | KEC 120
...
Please check the [course web page](<http://ycpcs.github.io/cs456-fall2026/>), regularly for important announcements.
...
This is primarily a discussion based class and as such the quality of the class periods will be dependent on the level of student engagement. In order to fully participate in the discussions, it is **critical** that you read any assigned material prior to class. It will also be helpful to highlight any points you find interesting to bring up during the discussions.
...
-   All graded work is to be completed individually. I encourage you to discuss high level concepts with other students, but any work you submit **must be yours alone**.
...
-   Any sources (books, websites, articles, fellow students, etc.), except for the course materials, that you consult in completing an assignment **must be properly acknowledged**. In general, I strongly discourage you from using any resource not explicitly listed in the course syllabus or on the course web page but rather asking the instructor for assistance.
